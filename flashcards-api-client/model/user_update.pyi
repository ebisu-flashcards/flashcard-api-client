...
class UserUpdate(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["password", "email", "is_active", "is_superuser", "is_verified", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["password", "email", "is_active", "is_superuser", "is_verified", ], str]):
