...
# body param
SchemaForRequestBodyApplicationJson = TagCreate


request_body_tag_create = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = TagRead
...
class BaseApi(api_client.Api):
    ...
    def _edit_tag_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_tag_create.serialize(body, content_type)
