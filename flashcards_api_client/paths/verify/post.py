...
# body param
SchemaForRequestBodyApplicationJson = BodyVerifyVerifyVerifyPost


request_body_body_verify_verify_verify_post = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = UserRead
...
class BaseApi(api_client.Api):
    ...
    def _verify_verify_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_body_verify_verify_verify_post.serialize(body, content_type)
...
class VerifyVerify(BaseApi):
    ...
    def verify_verify(
        ...
        return self._verify_verify_oapg(
            body=body,
