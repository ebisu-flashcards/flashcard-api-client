...
# body param
SchemaForRequestBodyApplicationXWwwFormUrlencoded = BodyAuthJwtLoginAuthJwtLoginPost
...
class AuthJwtLogin(BaseApi):
    ...
    def auth_jwt_login(
        ...
        return self._auth_jwt_login_oapg(
            body=body,
